...
const TextFileUpload = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto mt-5 pb-4 px-2">
      ...
      <div className="flex space-x-3 mt-6">
        <div className="lg:flex items-center w-full">
          <h1>Delimiter:</h1>
          <input className="bg-gray-100 px-2 py-2 w-full lg:ml-2" type="text" onChange={(e) => setDelimiter(e.target.value ? e.target.value : ",")} />
        </div>
        <div className="lg:flex items-center w-full">
          <h1>Lines:</h1>
          <input className="bg-gray-100 px-2 py-2 w-full lg:ml-2" type="text" onChange={(e) => setNumberOfLines(e.target.value ? e.target.value : Infinity)} />
        </div>
      </div>
          ...
          <table className="leading-normal w-full">
            <thead>
              <tr className="text-left">
                <th className="lg:px-5 w-1/2 px-3 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-sm font-bold text-gray-700">Name</th>
                <th className="lg:px-5 w-1/4 px-3 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-sm font-bold text-gray-700">Street</th>
                <th className="lg:px-5 w-1/4 px-3 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-sm font-bold text-gray-700">City</th>
                <th className="lg:px-5 w-1/4 px-3 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-sm font-bold text-gray-700">Country</th>
              </tr>
            </thead>
            <tbody>
              {readedLines.map(
